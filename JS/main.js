...
Como evolutivo de este simualador apruntaré a que se puedan consultar objetos con datos de logística (desde una API), desde donde se obtengan diferentes métodos de envío disponibles para el CP ingresado y que se evalúe el/los mejor/es SLAs de entrega disponible.
*/
...
const metodoEntrega = (array) => {
    for (let i = 0; i < array.length; i += 1) {
      if (ingresarCp <0) {
        return document.write('por favor ingresa un código postal válido');
      } else if (ingresarCp >= 1000 && ingresarCp <= 1500) {
